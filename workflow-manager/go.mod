module github.com/coredgeio/workflow-manager

go 1.22

require (
	github.com/argoproj/argo-workflows/v3 v3.5.12
	github.com/coredgeio/compass v0.0.0-20240927031206-e7679c71b1e4
	github.com/coredgeio/gosdkclient v0.0.0-20240725101041-a55d4754989b
	github.com/coredgeio/orbiter-auth v0.0.0-20240924170628-1fbc0ff1bb54
	github.com/coredgeio/orbiter-registry v0.0.0-20241021074456-0be98f48f9ea
